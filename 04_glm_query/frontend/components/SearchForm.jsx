...
const SearchForm = ({ searchInput, setSearchInput, loading, onSubmit }) => {
    ...
    return (
        <form onSubmit={onSubmit} className="mt-1 grid grid-cols-12  shadow-lg">
            <SelectNetwork networks={networks} network={selectedNetwork} setNetwork={setSelectedNetwork} colSpan={"2"} />
            <input
                type="text"
                name="address"
                required
            ...
            <div className="col-span-2">
                <button type="submit" className="relative text-white  text-lg bg-golemblue px-8 md:px-16 py-2 ">
