const navigation = {
    first: [
        ...
        { name: "Become a Provider", href: "https://www.golem.network/platform/#Become-a-provider" },
        { name: "Stats", href: "https://stats.golem.network/" },
    ],
    second: [
        { name: "SDK", href: "https://handbook.golem.network/" },
        { name: "Requestor docs", href: "https://handbook.golem.network/requestor-tutorials/flash-tutorial-of-requestor-development" },
        { name: "Test harness", href: "https://handbook.golem.network/requestor-tutorials/interactive-testing-environment" },
        { name: "Github", href: "https://github.com/golemfactory" },
    ],
    third: [
        { name: "Feature projects", href: "https://www.golem.network/community" },
        { name: "Awesome Golem", href: "https://www.golem.network/community#Awesome-Golem" },
        { name: "Upcoming events", href: "https://www.golem.network/community#Upcoming-Events" },
...
const Footer = () => {
    return (
        <footer className="bg-primary border-t border-gray-500 mt-64 mb-16" aria-labelledby="footer-heading">
            <h2 id="footer-heading" className="sr-only">
                Footer
            </h2>
            <div className="xl:grid xl:grid-cols-9 xl:gap-8 mt-8">
                <div className="space-y-8 col-span-3">
                    <img className="h-14 -ml-2" src="golem_create.png" alt="Golem Factory" />
                    <p className="text-sm leading-6 text-white">
                        Golem Network is a decentralized computing marketplace that supports Web3 in a most efficient way possible
                    </p>
                    <div className="flex space-x-6">
                        {navigation.social.map((item) => (
                            <a key={item.name} href={item.href} target="_blank" className="text-gray-600 hover:text-gray-500">
                        ...
                        <div>
                            ...
                            <ul role="list" className="mt-6 space-y-4">
                                {navigation.first.map((item) => (
                                    <li key={item.name}>
                                        <a href={item.href} target="_blank" className="text-sm leading-6 text-gray-500 hover:text-gray-300">
                                            {item.name}
                                        </a>
                                    </li>
                                ))}
