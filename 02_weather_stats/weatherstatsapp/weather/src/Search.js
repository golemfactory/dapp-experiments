...
const Search = () => {
    ...
    const handleResultClick = (clickedData) => {
        ...
        <div className="w-full">
            ...
            <div className="mt-8 mx-18">
                <form onSubmit={handleSearch} className="mt-1 flex rounded-md  rounded-r-full rounded-l-full shadow-lg">
                    ...
                    <button
                        type="submit"
                        className="relative  inline-flex items-center space-x-2 rounded-r-full text-white  text-lg bg-blue-500 px-8 md:px-16 py-2 "
                    >
                        Search
                    </button>
                </form>
