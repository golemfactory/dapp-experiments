...
const Footer = () => {
    return (
        <footer className="bg-primary border-t border-gray-500 mt-64 pb-16" aria-labelledby="footer-heading">
                ...
                <div className="space-y-8 col-span-3">
                    ...
                    <div className="flex space-x-6">
                        {navigation.social.map((item) => (
                            <a key={item.name} href={item.href} target="_blank" className="text-golemblue hover:text-gray-500">
